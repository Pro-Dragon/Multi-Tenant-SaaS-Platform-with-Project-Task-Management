...
## Overview
A comprehensive multi-tenant SaaS application with project and task management capabilities. The platform supports strict data isolation, role-based access control (RBAC), and subscription-based user limits.

**Base URL:** `http://localhost:5000/api`

## Table of Contents
1. [Authentication APIs](#authentication-apis)
2. [Tenant APIs](#tenant-apis)
...
**Error Cases:**
- `400` - Subdomain already exists or validation failed
- `500` - Server error
...
```json
{
  ...
  "password": "demo123",
  "tenantSubdomain": "demo"  // Optional, required for non-super_admin users
}
```
